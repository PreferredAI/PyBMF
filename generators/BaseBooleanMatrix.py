...
class BaseBooleanMatrix:
    ...
    def generate(self):
        raise NotImplementedError("[E] Missing generate method.")
    

    def generate_factors(self):
        raise NotImplementedError("[E] Missing generate_factors method.")
    

    def generate_factor(self):
        raise NotImplementedError("[E] Missing generate_factor method.")
