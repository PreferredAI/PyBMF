...
class BinaryMFThresholdExWolfe(BinaryMFThreshold):
    '''Binary matrix factorization, Thresholding algorithm, with self implemented Wolfe line search algorithm (experimental)
    '''
    ...
    def line_search(self, f, myfprime, xk, pk, maxiter, c1=0.4, c2=0.4):
        if f
